            ...
            <form action="{{ route('password.update') }}" method="post">
                ...
                <div class="h-full flex flex-col">
                    ...
                    <div class="flex flex-col">
                        <label for="password" class="text-dark text-xs-3 md:text-sm-2 md:font-bold mb-[3%] ">{{ __('new_password') }}</label>
                        <input type="password" name="password" placeholder="{{ __('enter_new_password') }}" class="input" >
                    </div>
                    <div class="flex flex-col">
                        <label for="password_confirmation" class="text-dark text-xs-3 md:text-sm-2 md:font-bold mb-[3%] ">{{ __('repeat_password') }}</label>
                        <input type="password" name="password_confirmation" placeholder="{{ __('repeat_password') }}" class="input" >
                    </div>
