        ...
        <div class="w-[343px] lg:w-[392px] flex flex-col  h-full lg:h-[460px]">
            ...
            <div class="h-full lg:flex lg:flex-col">
                ...
                <div class="flex flex-col">
                    <label for="email" class="text-dark text-xs-3 lg:text-sm-2 lg:font-bold mb-[3%] ">{{ __('email') }}</label>
                    <input type="email" name="email" placeholder="{{ __('enter_email') }}" class="input" >
                </div>
