...
<x-layout>
    ...
    <div id="container"  style="display: flex; flex-direction: column; align-items: center; height: 100vh;" >
        <img id="img" src="{{ asset('Landing.svg') }}" alt="dashboard-worldwide-screen" style=" margin-top: 16px; width: 300px; height: 241px">
        <p  style=" font-size: 20px; line-height: 24px; font-weight: bold; font-family: Inter; ">Confirmation email</p>
        ...
        <a id="btn" href="{{ route('user.verify-email', ['token' => $user->verifyUser->token]) }}"
